...
import {PylonProtocol} from './protocol.js';
...
export class VehicleUdp{
  ...
  async enable(sim){
    ...
    if(channel){
      ...
      catch(error){throw Error(`UDP受信ポート :${channel.commandPort} を利用できません (${error.code})`);}
