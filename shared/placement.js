import {PARTS,layoutCraft,surfaceRadius} from './craft.js';
...
export function resolvePlacement(craft,type,hit,{snap=true}={}){
...
export function placementParts(craft,type,placement,angles){
